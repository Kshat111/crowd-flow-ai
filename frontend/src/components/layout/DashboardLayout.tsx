    ...
    <div className="flex h-screen overflow-hidden bg-gray-100 dark:bg-gray-900">
      ...
      <div
        className={cn(
          ...
          mobileLeftMenuOpen ? "opacity-100" : "opacity-0 pointer-events-none"
        )}
      ...
      <div
        className={cn(
          ...
          mobileLeftMenuOpen ? "translate-x-0" : "-translate-x-full"
        )}
      >
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-gray-800">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">
      ...
      <div
        className={cn(
          "fixed inset-0 z-40 md:hidden bg-gray-600 bg-opacity-75 transition-opacity duration-300",
          mobileRightMenuOpen ? "opacity-100" : "opacity-0 pointer-events-none"
        )}
      ...
      <div
        className={cn(
          "fixed inset-y-0 right-0 z-50 w-80 bg-white dark:bg-crowdflow-blue-dark overflow-y-auto transition-transform duration-300 transform md:hidden",
          mobileRightMenuOpen ? "translate-x-0" : "translate-x-full"
        )}
      >
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-gray-800">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">
        ...
        <header className="bg-white dark:bg-crowdflow-blue-dark shadow-sm z-10 h-16 flex items-center px-4 justify-between">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="p-1.5 ml-4 rounded-md text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 md:hidden"
            >
              <Menu size={20} />
            </button>
          </div>
